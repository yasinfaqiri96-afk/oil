...
public partial class ReportsController : Controller
{
        ...
        IMemoryCache? cache = null)
    {
        ...
        _preSaleReservations = preSaleReservations ?? new PreSaleReservationService(
            db,
            clock ?? new AfghanistanBusinessClock(TimeProvider.System));
        ...
        [
            ...
            new()
            {
                ...
                [
                    ...
                    new()
                    {
                        ...
                        Icon = "bi-droplet-half", ToneClass = "tone-rose"
                    },
                    new()
                    {
            ...
            new()
            {
                ...
                [
                    ...
                    new()
                    {
                        Controller = "Reconciliation", Action = "Summary",
