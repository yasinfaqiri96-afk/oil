...
public class DashboardViewModel
{
    ...
    public List<DashboardContractProgressViewModel> ActiveContractProgress { get; set; } = new();
...
// یک ردیف «قرارداد/محموله در جریان»: مقدار بارگیری‌شده در برابر مقدار قرارداد.
public class DashboardContractProgressViewModel
{
    public int ContractId { get; set; }
    public string ContractNumber { get; set; } = "";
    public string SubtitleText { get; set; } = "";
    public string IconClass { get; set; } = "bi-journal-text";
